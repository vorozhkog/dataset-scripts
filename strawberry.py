...
# https://zenodo.org/record/6126677#.ZGN2RXbMIuV
...
projects = [
    r"C:\Users\German\Documents\strawberries\training",
    r"C:\Users\German\Documents\strawberries\validation",
]
...
project_name = os.path.basename(os.path.dirname(projects[0]))
