...
# https://zenodo.org/record/168158#.ZGZMvHbMIuV
...
datasets = [
    r"C:\Users\German\Documents\images_and_annotations\PSI_Tray031\tv",
]
...
# create object class
obj_class = sly.ObjClass("Arabidopsis Thaliana", sly.Bitmap)
